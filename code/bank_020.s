...
GameState26_SumireMiniGameMain::
	ld   a, [wGameSubstate]                                  ; $4000: $fa $a1 $c2
	rst  JumpTable                                         ; $4003: $df
	dw SumireMiniGameMainSubstate0
	dw SumireMiniGameMainSubstate1
	...
	ld   a, GS_SUMIRE_MINI_GAME_MAIN                                      ; $4027: $3e $26
	...
	ld   a, GS_SUMIRE_MINI_GAME_MAIN                                      ; $403a: $3e $26
...
if def(VWF)
	call SumireMiniGameHelpScreenTileAttrHook
else
...
if def(VWF)
	call SumireMiniGameHelpScreenTileMapHook
else
...
if def(VWF)
	call SumireMiniGameHelpScreenTileDataHook
else
...
;
	...
	ld   [wNapOrTrainIdx], a                                  ; $42d3: $ea $6d $ca
	ld   a, $90                                      ; $42d6: $3e $90
	ld   [wSCY], a                                  ; $42d8: $ea $08 $c2
	ld   [$ca6e], a                                  ; $42db: $ea $6e $ca
	jr   .cont_42f0                                 ; $42de: $18 $10

.br_42e0:
	ld   a, $48                                      ; $42e0: $3e $48
	ld   [wSCX], a                                  ; $42e2: $ea $07 $c2
	ld   [wNapOrTrainIdx], a                                  ; $42e5: $ea $6d $ca
	ld   a, $00                                      ; $42e8: $3e $00
...
jr_020_44a1:
	...
	ld   hl, wNapOrTrainIdx                                   ; $44aa: $21 $6d $ca
	add  [hl]                                        ; $44ad: $86
	ld   d, a                                        ; $44ae: $57
	ld   a, [$cad9]                                  ; $44af: $fa $d9 $ca
	ld   hl, wNapOrTrainIdx                                   ; $44b2: $21 $6d $ca
	add  [hl]                                        ; $44b5: $86
	cp   d                                           ; $44b6: $ba
...
jr_020_452d:
	...
	ld   a, $38                                      ; $454f: $3e $38
	call PlaySampledSound                                       ; $4551: $cd $64 $1b
...
jr_020_456f:
	...
	ld   a, $38                                      ; $457e: $3e $38
	call PlaySampledSound                                       ; $4580: $cd $64 $1b
...
Call_020_470b:
	...
	ld   b, a                                        ; $470e: $47
	ld   a, [wNapOrTrainIdx]                                  ; $470f: $fa $6d $ca
	add  b                                           ; $4712: $80
	ld   b, a                                        ; $4713: $47
...
jr_020_49cf:
	...
	add  hl, de                                      ; $49dc: $19
	ld   b, h                                        ; $49dd: $44
	ld   a, [wNapOrTrainIdx]                                  ; $49de: $fa $6d $ca
	ld   d, a                                        ; $49e1: $57
	ld   a, b                                        ; $49e2: $78
	add  d                                           ; $49e3: $82
	ld   b, a                                        ; $49e4: $47
...
Call_020_4d1a:
	...
	ld   c, a                                        ; $4d21: $4f
	ld   a, [wNapOrTrainIdx]                                  ; $4d22: $fa $6d $ca
	ld   d, a                                        ; $4d25: $57
	ld   a, b                                        ; $4d26: $78
	add  d                                           ; $4d27: $82
	ld   b, a                                        ; $4d28: $47
...
Call_020_4ff3:
	...
	ld   [wNapOrTrainIdx], a                                  ; $4ffa: $ea $6d $ca
...
Call_020_5059:
	...
	ld   [wNapOrTrainIdx], a                                  ; $5060: $ea $6d $ca
...
Call_020_50bf:
	ld   hl, Table_20_510b                                   ; $50bf: $21 $0b $51
	jr   :+                                 ; $50c2: $18 $03

Call_020_50c4:
	ld   hl, Table_20_512b                                   ; $50c4: $21 $2b $51
...
SumireMiniGameMainSubstate6:
	ld   hl, $ca4a                                   ; $530f: $21 $4a $ca
	ld   [hl], $05                                   ; $5312: $36 $05

SumireMiniGameMainSubstate7:
...
GameState25_KohranMiniGameMain::
	ld   a, [wGameSubstate] ; $6214: $fa $a1 $c2
	rst  JumpTable                           ; $6217: $df
	dw KohranMiniGameMainSubstate0
	dw $62f3
	dw $62ff
	dw KohranMiniGameMainSubstate3
	dw KohranMiniGameMainSubstate4
	dw KohranMiniGameMainSubstate5
	dw KohranMiniGameMainSubstate6
	dw KohranMiniGameMainSubstate7
	dw KohranMiniGameMainSubstate8
	dw $7906
	dw $6314
	...
	ld   a, GS_KOHRAN_MINI_GAME_MAIN                                      ; $623d: $3e $25
	...
	ld   a, GS_KOHRAN_MINI_GAME_MAIN                                      ; $6250: $3e $25
...
if def(VWF)
	call KohranMiniGameHelpScreenTileAttrHook
else
...
if def(VWF)
	call KohranMiniGameHelpScreenTileMapHook
else
...
if def(VWF)
	call KohranMiniGameHelpScreenTileDataHook
else
...
Jump_020_6b28:
	...
	ld   a, $5c                                      ; $6b49: $3e $5c
	call PlaySampledSound                                       ; $6b4b: $cd $64 $1b
...
jr_020_76d9:
	...
	call ConvertAintoBCD                                       ; $76e7: $cd $7d $0d
	ld   c, a                                        ; $76ea: $4f
	ld   a, $40                                      ; $76eb: $3e $40
	add  c                                           ; $76ed: $81
	ld   c, a                                        ; $76ee: $4f
...
jr_020_7723:
	...
	call ConvertAintoBCD                                       ; $7731: $cd $7d $0d
	ld   c, a                                        ; $7734: $4f
	ld   a, $40                                      ; $7735: $3e $40
	add  c                                           ; $7737: $81
	ld   c, a                                        ; $7738: $4f
...
GameState24_MiniGameDebugMenu::
	...
	ld   a, e                                        ; $79c2: $7b
	ld   a, h                                        ; $79c3: $7c
	ld   [wNapOrTrainReturnState], a                                  ; $79c4: $ea $4c $ca
	ld   a, l                                        ; $79c7: $7d
	ld   [wNapOrTrainReturnSubstate], a                                  ; $79c8: $ea $4d $ca
	ld   a, h                                        ; $79cb: $7c
	ld   [wNapOrTrainReturnState], a                                  ; $79cc: $ea $4c $ca
	ld   a, l                                        ; $79cf: $7d
	ld   [wNapOrTrainReturnSubstate], a                                  ; $79d0: $ea $4d $ca
	ret                                              ; $79d3: $c9
...
Jump_020_7b03:
	...
	ld   a, GS_TRAINING_DEBUG_MENU                                      ; $7b0b: $3e $2e
...
SumireMiniGameHelpScreenTileAttrHook:
KohranMiniGameHelpScreenTileAttrHook:
	call RLEXorCopy
...
SumireMiniGameHelpScreenTileMapHook:
	;call RLEXorCopy

	ld   a, BANK(TileMap_SumireMiniGameHelpScreen)
	ldbc $14, $12
	ld   de, TileMap_SumireMiniGameHelpScreen
	ld   hl, $d000
	call FarCopyLayout
	ret


SumireMiniGameHelpScreenTileDataHook:
	;call RLEXorCopy

	ld   a, BANK(Gfx_SumireMiniGameHelpScreen)
	ld   bc, Gfx_SumireMiniGameHelpScreen.end-Gfx_SumireMiniGameHelpScreen
	ld   de, $d000
	ld   hl, Gfx_SumireMiniGameHelpScreen
	call FarMemCopy
	ret


KohranMiniGameHelpScreenTileMapHook:
	;call RLEXorCopy

	ld   a, BANK(TileMap_KohranMiniGameHelpScreen)
	ldbc $14, $12
	ld   de, TileMap_KohranMiniGameHelpScreen
	ld   hl, $d000
	call FarCopyLayout
	ret


KohranMiniGameHelpScreenTileDataHook:
	;call RLEXorCopy

	ld   a, BANK(Gfx_KohranMiniGameHelpScreen)
