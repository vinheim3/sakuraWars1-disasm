...
; Set initial palettes to white, and update BG's
...
jr_03e_759d:
	call Call_03e_78a6                               ; $759d: $cd $a6 $78
	ld   a, $03                                      ; $75a0: $3e $03
...
jr_03e_75a5:
	...
	call Call_03e_784b                               ; $75d4: $cd $4b $78
	push af                                          ; $75d7: $f5
	ld   a, $47                                      ; $75d8: $3e $47
	...
	call Call_03e_78a6                               ; $75f2: $cd $a6 $78
	ld   hl, wGameSubstate                                   ; $75f5: $21 $a1 $c2
	inc  [hl]                                        ; $75f8: $34
	ld   a, $21                                      ; $75f9: $3e $21
	call Func_1adf                                       ; $75fb: $cd $df $1a
...
jr_03e_765d:
	...
	call Call_03e_78ee                               ; $7678: $cd $ee $78
	ld   a, $04                                      ; $767b: $3e $04
...
jr_03e_76a9:
	...
	call Call_03e_78a6                               ; $76ad: $cd $a6 $78
	ld   hl, wGameSubstate                                   ; $76b0: $21 $a1 $c2
	dec  [hl]                                        ; $76b3: $35
	ld   a, $22                                      ; $76b4: $3e $22
	call Func_1adf                                       ; $76b6: $cd $df $1a
...
jr_03e_79a7:
	...
	ld   de, $7180                                   ; $7b8e: $11 $80 $71
	push af                                          ; $7b91: $f5
	ld   a, $03                                      ; $7b92: $3e $03
	ld   [wFarCallAddr], a                                  ; $7b94: $ea $98 $c2
	ld   a, $41                                      ; $7b97: $3e $41
	ld   [wFarCallAddr+1], a                                  ; $7b99: $ea $99 $c2
	ld   a, $01                                      ; $7b9c: $3e $01
	ld   [wFarCallBank], a                                  ; $7b9e: $ea $9a $c2
	pop  af                                          ; $7ba1: $f1
	call FarCall                                       ; $7ba2: $cd $62 $09
	ld   a, $01                                      ; $7ba5: $3e $01
...
jr_03e_7bef:
	call Call_03e_7dde                               ; $7bef: $cd $de $7d
	push af                                          ; $7bf2: $f5
	ld   a, $43                                      ; $7bf3: $3e $43
	ld   [wFarCallAddr], a                                  ; $7bf5: $ea $98 $c2
	ld   a, $6a                                      ; $7bf8: $3e $6a
	ld   [wFarCallAddr+1], a                                  ; $7bfa: $ea $99 $c2
	ld   a, $11                                      ; $7bfd: $3e $11
	ld   [wFarCallBank], a                                  ; $7bff: $ea $9a $c2
	pop  af                                          ; $7c02: $f1
	call FarCall                                       ; $7c03: $cd $62 $09
	ld   a, $1e                                      ; $7c06: $3e $1e
...
jr_03e_7c47:
	...
	ld   a, $22                                      ; $7c5b: $3e $22
	call Func_1adf                                       ; $7c5d: $cd $df $1a

jr_03e_7c60:
	call Call_03e_7dde                               ; $7c60: $cd $de $7d
	ret                                              ; $7c63: $c9
...
jr_03e_7cca:
	call Call_03e_7dde                               ; $7cca: $cd $de $7d
	ret                                              ; $7ccd: $c9
...
jr_03e_7d05:
	...
	ld   a, $21                                      ; $7d09: $3e $21
	call Func_1adf                                       ; $7d0b: $cd $df $1a
	ld   hl, wGameSubstate                                   ; $7d0e: $21 $a1 $c2
	inc  [hl]                                        ; $7d11: $34

jr_03e_7d12:
	call Call_03e_7dde                               ; $7d12: $cd $de $7d
	ret                                              ; $7d15: $c9


	call Call_03e_7dde                               ; $7d16: $cd $de $7d
...
Call_03e_7dde:
	call ClearOam                                       ; $7dde: $cd $d7 $0d
	call AnimateAllAnimatedSpriteSpecs                                       ; $7de1: $cd $d3 $2e
	call Call_03e_7de8                               ; $7de4: $cd $e8 $7d
	ret                                              ; $7de7: $c9


Call_03e_7de8:
	ld   bc, $5020                                   ; $7de8: $01 $20 $50
	ld   a, $0a                                      ; $7deb: $3e $0a
	ld   [wSpriteGroup], a                                  ; $7ded: $ea $1a $c2
	ld   a, $47                                      ; $7df0: $3e $47
	call LoadSpriteFromMainTable                                       ; $7df2: $cd $16 $0e
	ld   bc, $5020                                   ; $7df5: $01 $20 $50
	ld   a, $0a                                      ; $7df8: $3e $0a
	ld   [wSpriteGroup], a                                  ; $7dfa: $ea $1a $c2
	ld   a, $48                                      ; $7dfd: $3e $48
	call LoadSpriteFromMainTable                                       ; $7dff: $cd $16 $0e
	ret                                              ; $7e02: $c9
